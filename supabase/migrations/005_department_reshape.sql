-- 005_department_reshape.sql
-- Final department set: Operations, Marketing, Sales, R&D, Clinical,
-- Regulatory + the three person boards (Ewan, Max, Marek Jr.).
-- Hard-deletes CEO Office (tasks cascade) and the dev-seed Finance team.
-- Renames Engineering -> R&D. Idempotent.
